...
namespace QueryEvaluator
{
    public class HCQueryEvaluator : QueryEvaluator
    {
        ...
        /// <summary>
        /// The map between a Hilbert value and the number of records
        /// mapped to the value.
        /// </summary>
        private Dictionary<int, int> hilbCount;
        ...
        private void LoadData(string dataPath, int order, CurveType ori)
        {
            ...
            hilbCount = new Dictionary<int, int>();
            ...
            try
            {
                    ...
                    line = streamReader.ReadLine())
                {
                    ...
                    if (match.Success)
                    {
                        ...
                        {
                            hilbCount[hilbVal] = hilbCount[hilbVal] + 1;
                        }
                        else
                        {
                            hilbCount.Add(hilbVal, 1);
                        }
                    }
                }
            }
